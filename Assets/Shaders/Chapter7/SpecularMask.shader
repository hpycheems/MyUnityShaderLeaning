Shader "Unlit/SpecularMask"
{
    Properties
    {
        ...
        _SpecularMask ("Mask", 2D) = "while"{}
        _MaskScle ("MaskScale", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed SpecularMask = tex2D(_SpecularMask, i.uv.xy).r * _MaskScle;
                fixed3 specular = _LightColor0.rgb * _Specular * pow(max(0, dot(worldNormal, halfDir)), _Gloss) * SpecularMask;
